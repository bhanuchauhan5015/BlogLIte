...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\My_all_flask_apps\flask_full_fledged\flask_login_logout\myenv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\My_all_flask_apps\flask_full_fledged\flask_login_logout\myenv\Scripts\deactivate.nu'
